  ...
  return (
    <div className=' h-screen'>
        <div className=' h-full'>
            <div className=' p-20 h-1/2 bg-stone-200 flex items-center justify-center'>
                <p className=' text-xl w-3/4 text-neutral-600'>
            ...
            <div className=' p-20 h-1/2 bg-stone-100 flex items-center justify-center'>
                <p className=' text-xl w-3/4 text-neutral-700'> 
