...
const Third = () => {
  return (
    <div className=' bg-neutral-100  p-5 md:p-10 md:flex md:gap-10 lg:p-20'>
        ...
        <div className=' flex flex-col justify-center gap-5 mt-10 md:mt-0 md:flex-1'>
            <div>
                <p className=' text-left text-2xl md:text-xl lg:text-3xl font-semibold text-neutral-600'>
            ...
            <div>
                ...
                <span className=' text-green-500'>&#10004;</span> Copyright Protection <br />
                </p>
            </div>
